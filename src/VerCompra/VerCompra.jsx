...
class VerCompra extends React.Component {
    ...
    componentDidMount(){
        if(this.getId() > 0){
            axios.post(BUY_ONE, {id: this.getId()})
            .then((r) => {
                this.setState({
                    data : r.data,
                    loading : false
                                ...
                                <tbody>
                                    { data.productos.map((p, i) => 
                                        <tr key={i}>
                                            ...
                                            <td>${Math.round(p.cantidad*p.precio_compra*100)/100}</td>
                                        </tr>
                                    ) }
                                </tbody>
                            </table>
...
export default withStyles(styles, { withTheme: true })(VerCompra);